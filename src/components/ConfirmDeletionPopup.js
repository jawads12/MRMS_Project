...
const ConfirmDeletionPopup = ({ onClose }) => {
  ...
  return (
    <div className="relative bg-white shadow-[0px_4px_100px_rgba(0,_0,_0,_0.25)] w-[432px] h-[296px] overflow-hidden max-w-full max-h-full text-center text-13xl text-black font-poppins">
      <label
        className="absolute top-[60px] left-[27px] font-medium inline-block w-[390px] h-[61px]"
        id="studentname"
      >
      ...
      />
      <div
        className="absolute top-[189px] left-[20px] w-[233px] h-[61px] flex flex-row items-center justify-center cursor-pointer"
      ...
      <div
        className="absolute top-[189px] left-[177px] w-[233px] h-[61px] flex flex-row items-center justify-center cursor-pointer"
