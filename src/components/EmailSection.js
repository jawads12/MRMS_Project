const EmailSection = () => {
  return (
    <div className="absolute top-[7135px] left-[-7px] w-[1719px] h-[346px] text-left text-5xl text-[inherit] font-inter">
      <div className="absolute top-[0px] left-[0px] w-[1719px] h-[394px]">
        <div className="absolute top-[21px] left-[6px] bg-darkslategray-200 w-[1713px] h-[373px]" />
        <img
